  ...
  es: {
    ...
    legal: {
      terms: {
        ...
        s1_desc: "Al acceder y utilizar este sitio web y los servicios de Bonanza | Bienestar, usted acepta cumplir con estos términos. Nuestros servicios están destinados exclusivamente para fines de relajación y bienestar holístico.",
        ...
        s3_desc: "Para su seguridad, todos los pagos con tarjeta de crédito o débito se procesan a través de la plataforma externa Stripe. Bonanza | Bienestar no almacena ni tiene acceso a los datos completos de su tarjeta. Al realizar un pago, usted acepta también los términos de servicio de Stripe.",
  ...
  en: {
    ...
    legal: {
      terms: {
        ...
        s1_desc: "By accessing this website and the services of Bonanza | Bienestar, you agree to comply with these terms. Our services are intended solely for relaxation and holistic well-being purposes.",
        ...
        s3_desc: "For your security, all credit and debit card payments are processed through the external platform Stripe. Bonanza | Bienestar does not store or have access to your full card details. By making a payment, you also accept Stripe's terms of service.",
