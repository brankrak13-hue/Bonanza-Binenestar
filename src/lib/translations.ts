...
export const translations: any = {
  es: {
    ...
    admin: {
      ...
      promoTab: "Promos",
      promoTitle: "Gestión de Promociones",
      promoDesc: "Activa o desactiva el popup de la página principal.",
      promoActive: "Anuncio Activo",
      promoImage: "Imagen del Popup",
    ...
    profile: {
      ...
      deleteDesc: "Una vez que elimines tu cuenta, no podrás recuperar tus datos ni tus reservas activas.",
      savedAddress: "Dirección Guardada",
      useSavedAddress: "Usar mi dirección guardada",
      saveForFuture: "Guardar para mi próxima compra",
    },
    promo: {
      title: "¡Promoción de Primavera!",
      subtitle: "REBAJAS DE TEMPORADA",
      code: "Usa el código:",
      cta: "Cerrar",
    },
    reserve: {
      title: "Agenda Tu Cita",
      subtitle: "RESERVA TU ESPACIO",
      codeDesc: "Ingresa el código secreto que te enviamos por correo electrónico luego de tu compra.",
      codePlaceholder: "Ej: BNZ-XXXXXX",
      verifyButton: "Validar Entrada",
      verifying: "Verificando...",
      locationTitle: "¿Dónde será tu sesión?",
      locationDesc: "Elige si prefieres venir a nuestro local o recibir el servicio en la comodidad de tu hogar.",
      optionLocal: "En el Local",
      optionLocalDesc: "Sin costo adicional. Ubicación en zona céntrica.",
      optionHome: "A Domicilio",
      optionHomeDesc: "Costo adicional de $300 MXN / $15 USD (se paga al recibir el servicio).",
      detailsTitle: "Detalles del Servicio",
      detailsDesc: "Por favor, completa la información necesaria para coordinar tu visita.",
      addressLabel: "Dirección Completa",
      addressPlaceholder: "Calle, número exterior/interior...",
      coloniaLabel: "Colonia / Zona",
      cpLabel: "Código Postal",
      mapsLabel: "Enlace de Google Maps",
      mapsPlaceholder: "Pega el enlace de 'Compartir' aquí...",
      mapsHelp: "Cómo obtener el enlace: Abre Google Maps -> Busca tu ubicación -> Compartir -> Copiar enlace.",
      peopleLabel: "Número de personas",
      gatedLabel: "Confirmo que mi domicilio tiene caseta / seguridad y avisaré con 1h de anticipación.",
      next: "Siguiente",
      back: "Volver",
      timeTitle: "Elige tu Momento",
      timeDesc: "Has desbloqueado el acceso para organizar tu paz interior.",
      confirmButton: "Confirmar Cita",
      booking: "Agendando...",
      successTitle: "¡Equilibrio Sellado!",
      successDesc: "Tu agenda está lista. Te esperamos el día seleccionado para iniciar tu viaje en Bonanza.",
  ...
  en: {
    ...
    admin: {
      ...
      promoDesc: "Toggle the main homepage popup on or off.",
      promoActive: "Ad Active",
      promoImage: "Popup Image",
    ...
    profile: {
      ...
      deleteDesc: "Once you delete your account, you will not be able to recover your data or active reservations.",
      savedAddress: "Saved Address",
      useSavedAddress: "Use my saved address",
      saveForFuture: "Save for my next purchase",
    },
    promo: {
    ...
    reserve: {
      ...
      codeDesc: "Enter the secret code sent to your email after purchase.",
      codePlaceholder: "E.g.: BNZ-XXXXXX",
      verifyButton: "Validate Code",
      verifying: "Verifying...",
      locationTitle: "Where will your session be?",
      locationDesc: "Choose if you prefer to come to our location or receive the service in the comfort of your home.",
      optionLocal: "At the Salon",
      optionLocalDesc: "No extra cost. Central location.",
      optionHome: "At Home",
      optionHomeDesc: "Additional cost of $300 MXN / $15 USD (paid at the time of service).",
      detailsTitle: "Service Details",
      detailsDesc: "Please complete the necessary information to coordinate your visit.",
      addressLabel: "Full Address",
      addressPlaceholder: "Street, exterior/interior number...",
      coloniaLabel: "Neighborhood / Area",
      cpLabel: "Zip Code",
      mapsLabel: "Google Maps Link",
      mapsPlaceholder: "Paste the 'Share' link here...",
      mapsHelp: "How to get the link: Open Google Maps -> Search your location -> Share -> Copy link.",
      peopleLabel: "Number of people",
      gatedLabel: "I confirm my residence has a gate/security and I will notify them 1h in advance.",
      next: "Next",
      back: "Back",
      timeTitle: "Choose Your Moment",
      timeDesc: "You have unlocked access to organize your inner peace.",
      confirmButton: "Confirm Appointment",
      booking: "Booking...",
      successTitle: "Balance Sealed!",
      successDesc: "Your schedule is ready. We wait for you on the selected day to start your journey in Bonanza.",
