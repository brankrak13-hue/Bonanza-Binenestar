    ...
    <section className="relative w-full h-[calc(100vh-120px)] min-h-[600px] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <Image
          ...
          fill
          priority
          className="object-cover transition-transform duration-[10s] ease-out scale-110 hover:scale-100"
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-4xl mx-auto">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-9xl font-bold mb-8 leading-[1.1] animate-fadeIn opacity-0" style={{ animationDelay: '400ms' }}>
          {title}
        </h1>
        ...
        <div className="animate-fadeIn opacity-0" style={{ animationDelay: '800ms' }}>
          <Link href={buttonLink} className="btn-outline group inline-flex items-center gap-2">
            {buttonText}
